...
public class ReportHandler extends AbstractHandler {
    ...
    public ReportHandler(UserService userService, ReportsService reportsService, TelegramBot telegramBot, ShelterMessageImpl shelterMessage, FileService fileService) {
